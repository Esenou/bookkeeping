 ...
 alter table if exists tbl_product_employees add constraint FK7n6qipcx3oftofa9fd3lgvbtl foreign key (employees_id) references tbl_employee;
 alter table if exists tbl_product_employees add constraint FKske3vtfcb1ooj8q1vh361uy21 foreign key (products_id) references tbl_product;
